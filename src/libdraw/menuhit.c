...
menucolors(void)
{
	...
	high = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xA4C2BDFF);	/* dark green */
	bord = allocimage(display, Rect(0,0,1,1), screen->chan, 1, 0xA4C2BDFF);	/* not as dark green */
