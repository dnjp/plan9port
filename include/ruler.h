...
/* Canonical request attribute names */
...
#define RulerType	"type"		/* window type hint, e.g. "file", "win"; optional, used for matching */
...
struct Rulerreq {
	...
	char	*event;
	char	*id;
	char	*type;		/* optional window type hint, e.g. "file", "win" */
};
